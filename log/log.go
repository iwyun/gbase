...
func GetStdout() io.Writer {
	return loggerInstance.segment.logFile
}
...
func (l Logger) RedirectSTDOutput() error {
	if l.segment.logFile != nil {
		/*if err := syscall.Dup2(int(l.segment.logFile.Fd()), int(os.Stderr.Fd())); err != nil {
			return err
		}*/
...
func Alertln(v ...interface{}) {
	loggerInstance.doPrintln(ALERT, v...)
}
func Alertf(format string, v ...interface{}) {
	loggerInstance.doPrintf(ALERT, format, v...)
}

func SetLevel(level int) {
	loggerInstance.level = LogLevel(level)
}
